...
public class GameState {
     ...
     * 
     * Architecture note (v1.6.0):
     * - Stores ONLY immutable game state (zones, counters, status flags)
     * - Derived values (current P/T, keywords) are computed from card DB + this state
     */
    public static class ObjectState {
        ...
        /** v1.6.0: Summoning sickness flag. True if creature entered this turn and lacks haste. */
        ...
        public boolean isSummoningSick() { return summoningSick; }
        public void setSummoningSick(boolean summoningSick) { this.summoningSick = summoningSick; }
